class SceneMenu extends Phaser.Scene {
    ...
    create ()
    {
        ...
        this.button1 = this.add.image(this.x, this.y-80,'button1'), () => this.scene.start('SceneGame');
        this.button1.setInteractive({ useHandCursor: true }).on('pointerdown', () => this.scene.start('SceneGame'));
